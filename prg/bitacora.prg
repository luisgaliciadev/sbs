LPARAMETERS VlN_accion,VlN_entidad,Vlc_descri,Vlc_motivo,vln_idbl,vln_idmod
...
IF conex > 0 
		...
		lsql="INSERT INTO bitacora (cedula,id_accion,id_entidad,descripcion,motivo,id_bl,id_mod)"+;
		" values(?Vgc_usuario,?Vln_accion,?Vln_entidad,?Vlc_descri,?Vlc_motivo,?vln_idbl,?vln_idmod)"
